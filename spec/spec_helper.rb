...
env_var_passed_via_detector_prefix_path = 'tmp/env_var_passed_via_KNAPSACK_PRO_RSPEC_TEST_EXAMPLE_DETECTOR_PREFIX.txt'
File.write(env_var_passed_via_detector_prefix_path , nil)
